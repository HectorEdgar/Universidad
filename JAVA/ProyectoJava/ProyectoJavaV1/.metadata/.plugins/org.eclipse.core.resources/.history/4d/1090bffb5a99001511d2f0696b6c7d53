...
public class PanelCalcularNomina extends JPanel {
	...
	public PanelCalcularNomina() {
		...
		this.jlTitulo.setBounds(300, 100, 60, 30);

		this.jlEmpleados = new JLabel("Empleados");
		this.jlEmpleados.setBounds(300, 100, 60, 30);
		this.jlEmpleadosNomina = new JLabel("Reporte de nomina");
		this.jlEmpleadosNomina.setBounds(300, 100, 60, 30);

		this.jlEjecutivos = new JLabel("Ejecutivos");
		this.jlEjecutivos.setBounds(300, 100, 60, 30);
		this.jlEjecutivosNomina = new JLabel("Reporte de nomina");
		this.jlEjecutivosNomina.setBounds(300, 100, 60, 30);

		this.jlDirectivos = new JLabel("Directivos");
		this.jlDirectivos.setBounds(300, 100, 60, 30);
		this.jlDirectivosNomina = new JLabel("Reporte de nomina");
		this.jlDirectivosNomina.setBounds(300, 100, 60, 30);

		this.jlNominatotal = new JLabel("Nomina Total");
		this.jlNominatotal.setBounds(300, 100, 60, 30);
