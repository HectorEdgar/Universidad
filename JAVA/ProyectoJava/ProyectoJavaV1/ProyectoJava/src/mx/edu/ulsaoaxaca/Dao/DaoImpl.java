...
public class DaoImpl implements Dao {
	...
	public Cuenta ValidarUsuario(Cuenta cuenta) {
		...
		String consulta = "SELECT * FROM CUENTA,PERSONA,PERFIL WHERE CUEN_USUARIO = \"" + usuario + "\" AND " + 
				 "CUEN_CONTRASENA = \""+contrasena+"\" AND CUEN_PERSONA_ID = PERSONA_ID" + " AND CUEN_PERFIL_ID = ID_PERFIL";
