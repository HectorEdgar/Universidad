...
public class NominaDaoImpl implements NominaDao {
	...
	public ArrayList<Persona> CalcularNomina() {
		...
		String consultaEmpleados = "SELECT * FROM EMPLEADOS,PERSONAS WHERE EMPL_PERSONA_ID = PERSONA_ID ";
		String consultaEjecutivos = "SELECT * FROM EMPLEADOS,EJECUTIVOS,PERSONAS WHERE PERSONAS.PERSONA_ID=EMPLEADOS.EMPL_PERSONA_ID AND EMPLEADOS.EMPLEADO_ID = EJECUTIVOS.EJEC_EMPLEADO_ID;";
		String consultaDirectivos = "SELECT * FROM EMPLEADOS,DIRECTIVOS,PERSONAS WHERE PERSONAS.PERSONA_ID=EMPLEADOS.EMPL_PERSONA_ID AND EMPLEADOS.EMPLEADO_ID = DIRECTIVOS.DIRE_EMPLEADO_ID;";
