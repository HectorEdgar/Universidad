...
public class PanelAltaEjecutivo extends JPanel{
	...
	public PanelAltaEjecutivo() {
		...
		this.jlBono = new JLabel("Bono: ");
		this.jlBono.setBounds(x, y + 180, 250, 20);
		this.jtBono = new JTextField();
		this.jtBono.setBounds(x + 300, y + 180, 200, 20);
		...
		this.jbAgregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (jcDomicilioParticular.isSelected() == false && jcDomicilioFiscal.isSelected() == false) {
					...
					ejec.setId(String.valueOf(id));
					ejec.setNombre(jtNombre.getText());
					ejec.setFechaNacimiento(jtFechaNacimiento.getText());
					ejec.setSexo(jtSexo.getText());
					ejec.setNss(jtNss.getText());
					ejec.setSueldo(jtSueldo.getText());
					ejec.setBono(jtBono.getText());
					EjecutivoDao ejecDao = new EjecutivoDaoImpl();
					int filasAfectadas = ejecDao.GrabarEjecutivo(ejec);
					if (filasAfectadas != 0) {
		...
		this.jbAgregarDomicilios.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (jtDomicilioParticularCalle.getText().trim().length() == 0) {
					...
					ejec.setDomicilioParticular(dom);
