...
<asp:Content ID="Content1" ContentPlaceHolderID="content3" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="idpost" DataSourceID="EntityDataSource1" ShowFooter="True" ShowHeaderWhenEmpty="True">
        <Columns>
            ...
            <asp:TemplateField HeaderText="idpost" SortExpression="idpost">
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("idpost") %>'></asp:Label>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtNewId" runat="server"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("idpost") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="idcomentario,comentario1,hora" DataSourceID="EntityDataSource2" ShowFooter="True" ShowHeaderWhenEmpty="True">
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Update" Text="Actualizar"></asp:LinkButton>
            ...
            <asp:TemplateField HeaderText="idcomentario" SortExpression="idcomentario">
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("idcomentario") %>'></asp:Label>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtNewIdComentario" runat="server"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("idcomentario") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="usuario" SortExpression="usuario">
                <EditItemTemplate>
